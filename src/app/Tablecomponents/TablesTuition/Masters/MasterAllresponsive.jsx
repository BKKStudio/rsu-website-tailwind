    ...
    <>
      <table className="  w-full text-center mt-4 ">
        <thead className="bg-gray-700 text-white">
          <tr className="border ">
            <th rowspan="2" className="border p-3 max-lg:p-0 max-lg:text-sm">
              คณะ/สาขาวิชา
            </th>
            <th colspan="3" className="border p-3 max-lg:p-0 max-lg:text-sm">
              ภาคการศึกษา
            </th>
            <th rowspan="2" className="border p-3 max-lg:p-0 max-lg:text-sm">
              ตลอดหลักสูตร
          ...
          <tr className="border ">
            <th className="border p-3 max-lg:p-0 max-lg:text-sm">ปกติ</th>
            <th className="border p-3 max-lg:p-0 max-lg:text-sm">
              เสาร์-อาทิตย์
            </th>
            <th className="border p-3 max-lg:p-0 max-lg:text-sm">อาทิตย์</th>
          </tr>
        </thead>
        <tbody className="">
          ...
          <tr className="border bg-gray-500 text-white">
            <th
              colspan="5"
              className="border p-3 max-lg:p-0 max-lg:text-sm max-md:text-xs text-start"
            >
              กลุ่มธุรกิจ-เศรษฐศาสตร์
            </th>
          </tr>
          <tr className="border ">
            ...
            <td className="border p-3 max-lg:p-0 max-lg:text-sm max-md:text-xs ">
              -
            </td>
            <td className="border p-3 max-lg:p-0 max-lg:text-sm">
              {" "}
          ...
          <tr className="border ">
            ...
            <td className="border p-3 max-lg:p-0 text-sm max-md:text-xs">
              {" "}
